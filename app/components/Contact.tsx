  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="rounded-3xl border border-neutral-800 bg-neutral-950 px-6 py-16 text-center sm:px-12">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-neutral-500">
            I&apos;m open to connecting with employers, clients, and teams
            looking for a software engineer experienced with Laravel and
